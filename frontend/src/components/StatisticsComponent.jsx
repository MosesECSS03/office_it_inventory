...
import '../css/StatisticsComponent.css';
...
class StatisticsComponent extends Component {
  ...
  constructor(props) {
    super(props);
    this.state = {
      // Remove modal state as it's now handled by MainPage
    };
  }
  ...
  // Method to open breakdown modal (now calls parent handler)
  openBreakdownModal = (subTab = 'summary') => {
    if (this.props.onOpenBreakdownModal) {
      this.props.onOpenBreakdownModal('status', subTab);
    }
  };
          ...
          <div className="stats-section">
            <div className="stats-section-header">
              ...
              <button 
                ...
                onClick={() => this.openBreakdownModal('summary')}
